...
ActiveRecord::Schema.define(version: 2019_01_31_173232) do
  ...
  create_table "doctors", force: :cascade do |t|
    ...
    t.string "zip_code"
    t.integer "city_id"
    t.integer "speciality_doctor_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["city_id"], name: "index_doctors_on_city_id"
    t.index ["speciality_doctor_id"], name: "index_doctors_on_speciality_doctor_id"
  end
  ...
  create_table "specialities", force: :cascade do |t|
    ...
    t.index ["speciality_doctor_id"], name: "index_specialities_on_speciality_doctor_id"
  end
